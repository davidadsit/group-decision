    ...
    public class InstantRunOffTests
    {
        public class ThreeCandidateTests
        {
            public ThreeCandidateTests()
            {
                ...
                votingSystem.RecordBallots(new Ballot("Blue", "Red"));
                votingSystem.RecordBallots(new Ballot("Blue", "Red", "Green"));
                votingSystem.RecordBallots(new Ballot("Blue", "Green"));
                votingSystem.RecordBallots(new Ballot("Red", "Green"));
                votingSystem.RecordBallots(new Ballot("Red", "Blue"));
                votingSystem.RecordBallots(new Ballot("Red", "Green"));
